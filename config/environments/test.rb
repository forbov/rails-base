...
Rails.application.configure do
  ...
  config.from_email = Rails.application.credentials.dig(:test, :smtp, :email)
  ...
  config.action_mailer.smtp_settings = {
    ...
    port: 587, # 465,
    domain: 'computability.com.au', # Replace with your domain
    user_name: Rails.application.credentials.dig(:test, :smtp, :email), # Replace with your full Bluehost email address
    password: Rails.application.credentials.dig(:test, :smtp, :password), # Replace with your email password
